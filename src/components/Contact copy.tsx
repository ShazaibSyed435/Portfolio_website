...
export default function Contact() {
  const contactItems = [
    ...
    },
    {
      icon: Github,
      label: "GitHub",
      value: "github.com/shazaib",
      href: "https://github.com/shazaib",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "linkedin.com/in/shazaib",
      href: "https://linkedin.com/in/shazaib",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              >
                <a
                  href="mailto:syedshazaib628@gmail.com"
                  className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-teal-400 via-fuchsia-400 to-teal-400 px-6 py-4 text-white font-semibold shadow-lg shadow-teal-500/20 transition-all hover:scale-105"
                >
                  <Mail size={18} />
              ...
              {contactItems.map((item, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className="group flex items-center justify-between rounded-2xl border border-slate-800 bg-slate-900/50 px-5 py-5 backdrop-blur-md transition-all hover:border-teal-500/40 hover:bg-slate-900/80"
                  >
